...
def plot_pitchcontrol_for_event( event_id, events,  tracking_home, tracking_away, PPCF, alpha = 0.7, include_player_velocities=True, annotate=False, field_dimen = (106.0,68), vmin=0.0, vmax=1.0, colorbar=False):
...
def plot_EPV_for_event( event_id, events, tracking_home, tracking_away, PPCF, EPV, alpha = 0.7, include_player_velocities=True, annotate=False, autoscale=0.1, contours=False, field_dimen = (106.0,68), vmin=0.0, vmax=0.6):
...
def plot_EPV(EPV,field_dimen=(106.0,68),attack_direction=1, vmin=0, vmax=0.6):
...
def save_match_clip_OBSO(hometeam,awayteam, OBSO, fpath, fname='clip_test', figax=None, frames_per_second=25, team_colors=('r','b'), field_dimen = (106.0,68.0), include_player_velocities=False, PlayerMarkerSize=10, PlayerAlpha=0.7, annotate=False, vmin=0,vmax=0.3):
    """ save_match_clip( hometeam, awayteam, fpath )
...
def save_match_clip_custom(attack_true, attack_pre, defense_true, defense_pre, OBSO_true, OBSO_pre,fpath, fname='clip_test', figax=None, frames_per_second=25, team_colors=('r','b'), 
                        field_dimen = (106.0,68.0), include_player_velocities=False, PlayerMarkerSize=10, PlayerAlpha=0.7, annotate=False,annotate_pre=False,pkl_save=False,pkl_path='./'):
...
def save_match_clip_custom_only2(attack_true, attack_pre, defense_true, defense_pre, OBSO_true, OBSO_pre,fpath, fname='clip_test', figax=None, frames_per_second=25, 
                            team_colors=('r','b'), field_dimen = (106.0,68.0), include_player_velocities=False, PlayerMarkerSize=10, PlayerAlpha=0.7, annotate=False,pkl_save=False,pkl_path='./'):
    """ save_match_clip( hometeam, awayteam, fpath )
...
def save_video_pre(attack_true, attack_pre, defense_true, defense_pre,fpath, fname='clip_test', figax=None, frames_per_second=8, team_colors=('r','b'), 
                        field_dimen = (106.0,68.0), include_player_velocities=False, PlayerMarkerSize=10, PlayerAlpha=0.7, annotate=False,annotate_pre=False):
