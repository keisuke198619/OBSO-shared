...
fig,ax = mviz.plot_events( events.loc[820:823], color='k', indicators = ['Marker','Arrow'], annotate=True )
fig.savefig("./figure/Tutorial3/Tutorial3-0.png")
...
fig,ax = mviz.plot_pitchcontrol_for_event( 820, events,  tracking_home, tracking_away, PPCF, annotate=True )
fig.savefig("./figure/Tutorial3/Tutorial3-1-1.png")
...
fig,ax = mviz.plot_pitchcontrol_for_event( 821, events,  tracking_home, tracking_away, PPCF, annotate=True )
fig.savefig("./figure/Tutorial3/Tutorial3-1-2.png")
...
fig,ax = mviz.plot_pitchcontrol_for_event( 822, events,  tracking_home, tracking_away, PPCF, annotate=True )
fig.savefig("./figure/Tutorial3/Tutorial3-1-3.png")
...
fig.savefig("./figure/Tutorial3/Tutorial3-2.png")
...
# plot the events
fig,ax = mviz.plot_events( risky_passes, color='k', indicators = ['Marker','Arrow'], annotate=True )
fig.savefig("./figure/Tutorial3/Tutorial3-3.png")
